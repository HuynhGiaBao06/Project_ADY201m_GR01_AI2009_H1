[ Dữ liệu thô (Raw Data) ]
           ↓
==================================================================
 GIAI ĐOẠN 1: LUỒNG CHUNG (Áp dụng cho TẤT CẢ mô hình)
==================================================================
...
[ Dữ liệu sạch (Clean Data) nhưng VẪN CHỨA OUTLIER ]
           ↓
==================================================================
 GIAI ĐOẠN 2: PHÂN NHÁNH CỤC BỘ (Gắn chặt vào thuật toán)
==================================================================
        |                                       |
  [Nhánh 1: Logistic Regression]        [Nhánh 2: XGBoost / Random Forest]
        |                                       |
  Bước 1: Transformer lọc Outlier       Bước 1: Bỏ qua lọc Outlier
        ↓                                       ↓
