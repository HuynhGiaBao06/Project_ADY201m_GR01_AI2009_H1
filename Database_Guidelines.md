...
[file-tag: code-generated-file-0-1779418531559118884]

File Markdown này được tổ chức thành 4 giai đoạn rõ ràng:
1.  **Hướng dẫn xin cấp phép IP (Firewall)**: Nhắc nhở thành viên cách lấy IP gửi cho bạn (Leader) xử lý lỗi *Cannot connect*.
